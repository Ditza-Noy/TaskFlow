...
class SQSConfig:
    def __init__(self,
        ...
        self.queue_name = queue_name or os.getenv("SQS_QUEUE_NAME")
        ...
        self.sqs_client : SQSClient = self._get_sqs_client()
        self.queue_url: str = self.get_sqs_url(self.queue_name)
